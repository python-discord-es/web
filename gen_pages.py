...
for p_key, p_values in pages.items():
    ...
    # Hack for some empty paragraphs that give spaces
    # This is generated by using '<details>' and '<summary>'
    # in the 'pages/faq.md' page
    _content = _content.replace("<p><summary></p>", "<summary>")
    _content = _content.replace("<p></summary></p>", "</summary>")
